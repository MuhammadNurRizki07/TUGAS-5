...
class JadwalKuliahApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Jadwal Kuliah Muhamad Nur Rizki")
        ...
        # Buttons
        tk.Button(root, text="Tambah Jadwal", command=self.tambah_jadwal, bg="#808000", fg="white").grid(row=3, column=0, columnspan=2, pady=10)
        tk.Button(root, text="Simpan ke File", command=self.simpan_ke_file, bg="#808000", fg="white").grid(row=4, column=0, columnspan=2, pady=10)
        tk.Button(root, text="Tampilkan Jadwal", command=self.tampilkan_jadwal, bg="#808000", fg="white").grid(row=5, column=0, columnspan=2, pady=10)
